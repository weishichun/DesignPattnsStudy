...
int main()
{
    ...
    IWeiXinUser *pA1 = new Fans(pYou);
    pA1->SetFansName("张三");
    IWeiXinUser *pA2 = new Fans(pYou);
    pA2->SetFansName("李四");
    IWeiXinUser *pA3 = new Fans(pYou);
    pA3->SetFansName("王麻子");
    IWeiXinUser *pA4 = new Fans(pYou);
    pA4->SetFansName("小春");
    IWeiXinUser *pA5 = new Fans(pYou);
    pA5->SetFansName("丫头");
    IWeiXinUser *pA6 = new Fans(pYou);
    pA6->SetFansName("小赵");
    IWeiXinUser *pA7 = new Fans(pYou);
    pA7->SetFansName("小钱");
    IWeiXinUser *pA8 = new Fans(pYou);
    pA8->SetFansName("小孙");
    IWeiXinUser *pA9 = new Fans(pYou);
    pA9->SetFansName("小周");
    IWeiXinUser *pA10 = new Fans(pYou);
    pA10->SetFansName("小吴");
    pYou->GainFans(pA1);
    pYou->GainFans(pA2);
